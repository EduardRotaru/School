    ...
    public partial class Initial : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.SubjectModels", t => t.Subject_ID)
        ...
        {
            DropForeignKey("dbo.AspNetUsers", "Teacher_ID", "dbo.Teachers");
            DropForeignKey("dbo.AspNetUsers", "Student_ID", "dbo.StudentModels");
            DropForeignKey("dbo.AspNetUserRoles", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserLogins", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.AspNetUserClaims", "UserId", "dbo.AspNetUsers");
            DropForeignKey("dbo.Teachers", "Subject_ID", "dbo.SubjectModels");
